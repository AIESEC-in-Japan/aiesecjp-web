<template>
  <div class="policy-container">
    <div class="policy-content">
      ...
      <p>
        特定非営利活動法人アイセック・ジャパン(以下アイセック)は、海外インターンシップに参加される学生様をはじめとする関係者の皆様のプライバシーを尊重し、個人情報の取り扱いに関して以下のような指針を定め、それに従ってその保護に努めております。
      </p>
      ...
      <p>収集した個人情報の利用は、収集目的の達成のために必要な範囲に限り、ご本人の権利を損なわないように、十分配慮して行います。</p>
      <h2 class="policy-content-title">
        個人情報の管理・保護について
      </h2>
      <p>
        アイセックは、個人情報保護の責任者を置き、適切な管理を行うとともに、外部への流出防止に努めます。また、外部からの不正アクセス、紛失、破壊、改ざん等の危険に対しては、適切な安全対策を実施し、個人情報の保護に努めます。
      </p>
      <h2 class="policy-content-title">
        個人情報の第三者提供
      </h2>
      ...
      <p>
        弊団体は、本人から個人情報の開示を求められたときは、本人に対し遅滞なくこれを開示します。
      ...
      <p>
        ご本人自らに関する個人情報の訂正、削除のお申し出があった場合は、遅滞なく調査を行い、訂正、削除 を必要とする事由があるときは、遅滞なく訂正、削除を行います。アイセックは、訂正等を行った場合、または訂正等を行わない旨の決定をしたときは遅滞なく、これをご本人に通知します。
      </p>
      <h2 class="policy-content-title">
        見直し
      </h2>
      ...
      <p>
        個人情報保護方針(プライバシーポリシー)に関するお問い合わせについては、<span class="policy-content__underline"> info@aiesec.jp</span>までお問い合わせください。
      </p>
    </div>
  </div>
</template>
